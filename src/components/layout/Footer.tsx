      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.8fr_1fr_1fr]">
          <div className="space-y-6">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.28em] text-[#DE7B42]">Fast. Fair. Fixed.</p>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
              <span className="inline-flex items-center gap-2 rounded-full border border-[#3C4A67] bg-white/5 px-4 py-2 text-sm text-white">
                <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-[#DE7B42] text-[#253147]">🏠</span>
                Family-owned
              </span>
          ...
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[#DE7B42]">Services</p>
            <div className="mt-6 grid gap-3 text-sm leading-7">
              <Link href="/" className="transition hover:text-white">A/C Rejuvenation</Link>
              <Link href="/" className="transition hover:text-white">Repair & Tune-Up</Link>
              <Link href="/" className="transition hover:text-white">Repair or Replace?</Link>
              <Link href="/" className="transition hover:text-white">Water Quality Solutions</Link>
              <Link href="/" className="transition hover:text-white">Indoor Air Quality & Moisture Control</Link>
            </div>
          </div>

          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[#DE7B42]">Contact</p>
            <div className="mt-6 space-y-4 text-sm leading-7">
              <a href="tel:+12142527320" className="block text-xl font-semibold text-white">(214) 252-7320</a>
